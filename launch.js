...
(function () {
  ...
  // controlType is now fixed to gesture control (MediaPipe), no need to configure
  s = [['quality', ['低', '中', '高', '超高'], 3, 3, '画质: '], ['hud', ['关', '开'], 1, 1, 'HUD: '], ['godmode', ['关', '开'], 0, 1, '上帝模式: ']];
  ...
  $('step-2').onclick = function () {
    ...
    return init(0, s[0][3], s[1][3], s[2][3]); // controlType fixed to 0 (gesture override via CameraInput)
  };
  ...
  if (!hasWebGL()) {
    ...
    $('start').onclick = function () {
      ...
      return $('step-2').style.backgroundImage = "url(css/help-gesture.png)"; // Fixed gesture control guide
    };
  }
